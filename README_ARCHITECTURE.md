...
The server registers **47** MCP tools, all prefixed `ghostcrab_*`. Registration is centralized in [`src/tools/register-all.ts`](src/tools/register-all.ts). At build time, `ghostcrab tools list` prints the same definitions (see [`src/cli/runner.ts`](src/cli/runner.ts)). Smoke tests validate the expected public tool families and startup behavior (see [`scripts/mcp-smoke.mjs`](scripts/mcp-smoke.mjs)).

| Subsystem                                                    | Count | Tools                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------------------------------------------ | ----: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Facets** (Layer 2 facts + schema registry)                 |    15 | `ghostcrab_search`, `ghostcrab_csearch`, `ghostcrab_combined_search`, `ghostcrab_tool_search`, `ghostcrab_remember`, `ghostcrab_upsert`, `ghostcrab_count`, `ghostcrab_facet_catalog`, `ghostcrab_facet_inspect`, `ghostcrab_facet_validate`, `ghostcrab_facet_register`, `ghostcrab_schema_register`, `ghostcrab_schema_list`, `ghostcrab_schema_inspect`, `ghostcrab_onboarding_schemas` |
| **Graph** (`graph.*` / `pg_dgraph` / MindBrain HTTP)         |    14 | `ghostcrab_learn`, `ghostcrab_traverse`, `ghostcrab_coverage`, `ghostcrab_graph_diagnostics`, `ghostcrab_graph_gap_rules`, `ghostcrab_graph_gap_rules_import`, `ghostcrab_graph_gap_rules_delete`, `ghostcrab_entity_chunks`, `ghostcrab_graph_path`, `ghostcrab_graph_reindex`, `ghostcrab_collection_reindex`, `ghostcrab_graph_search`, `ghostcrab_graph_subgraph`, `ghostcrab_collection_facet_search`                     |
| **Loadout** (workspace presets)                              |     5 | `ghostcrab_loadout_seed`, `ghostcrab_loadout_list`, `ghostcrab_loadout_inspect`, `ghostcrab_loadout_apply`, `ghostcrab_loadout_suggest`                                                                                                                                                                                                                                                    |
| **Pragma** (projections + operational snapshot)              |     5 | `ghostcrab_modeling_guidance`, `ghostcrab_pack`, `ghostcrab_projection_get`, `ghostcrab_project`, `ghostcrab_status`                                                                                                                                                                                                                                                                       |
| **Session**                                                  |     1 | `ghostcrab_workspace_use`                                                                                                                                                                                                                                                                                                                                                                  |
| **Workspace** (`mindbrain`, DDL lifecycle, semantics export) |     8 | `ghostcrab_workspace_create`, `ghostcrab_workspace_list`, `ghostcrab_workspace_inspect`, `ghostcrab_workspace_export_model`, `ghostcrab_workspace_export_model_toon`, `ghostcrab_ddl_propose`, `ghostcrab_ddl_list_pending`, `ghostcrab_ddl_execute`                                                                                                                                       |
...
| **`ghostcrab_graph_diagnostics`**      | Read                                                                            | MindBrain HTTP diagnostics for required relation gaps, cardinality violations, isolated entities, small components, edge-type mismatches, evidence gaps, and coverage gaps                                                                                                                  |
| **`ghostcrab_graph_gap_rules`**        | Read                                                                            | MindBrain HTTP list of closed-world graph gap rules for a workspace or ontology                                                                                                                                                                                                             |
| **`ghostcrab_graph_gap_rules_import`** | Write                                                                           | MindBrain HTTP import of closed-world graph gap rules (upsert; `replace:true` for pack swap)                                                                                                                                                                                              |
| **`ghostcrab_graph_gap_rules_delete`** | Write                                                                           | MindBrain HTTP delete of gap rules by `rule_id`                                                                                                                                                                                                                                             |
...
| `ghostcrab_graph_diagnostics`      | Graph / ontology                               | No                           | MindBrain HTTP                              |
| `ghostcrab_graph_gap_rules`        | Graph / ontology                               | No                           | MindBrain HTTP                              |
| `ghostcrab_graph_gap_rules_import` | Graph / ontology                               | Yes                          | MindBrain HTTP                              |
| `ghostcrab_graph_gap_rules_delete` | Graph / ontology                               | Yes                          | MindBrain HTTP                              |
