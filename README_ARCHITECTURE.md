...
| **Graph** (`graph.*` / `pg_dgraph` / MindBrain HTTP)         |    13 | `ghostcrab_learn`, `ghostcrab_traverse`, `ghostcrab_coverage`, `ghostcrab_graph_diagnostics`, `ghostcrab_graph_gap_rules`, `ghostcrab_graph_gap_rules_import`, `ghostcrab_entity_chunks`, `ghostcrab_graph_path`, `ghostcrab_graph_reindex`, `ghostcrab_collection_reindex`, `ghostcrab_graph_search`, `ghostcrab_graph_subgraph`, `ghostcrab_collection_facet_search`                     |
...
| **`ghostcrab_graph_gap_rules_import`** | Write                                                                           | MindBrain HTTP import of closed-world graph gap rules                                                                                                                                                                                                                                       |
