...
References: [ARTIFACT_KINDS.md](../ghostcrab-shared/ARTIFACT_KINDS.md), [IMPORT_CLOSURE_GATES.md](../ghostcrab-shared/IMPORT_CLOSURE_GATES.md), [PROJECTIONS_DISCOVERY.md](../ghostcrab-shared/PROJECTIONS_DISCOVERY.md).

## Delivery context (optional)

Resolve `{starterkit}` via [STARTERKIT_PATHS.md](../ghostcrab-shared/STARTERKIT_PATHS.md) — Phase B1: `{starterkit}/personal-mcp/ROUTE_MAP.md` § projections and `{starterkit}/scripts/README_projection_tools.md`.
