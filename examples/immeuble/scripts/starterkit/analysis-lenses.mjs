...
export const BLIND_SPOT_MANAGER_PATTERNS = [
  {
    ...
    business_question:
      "Quels coproprietaires ont des impayes ou relances actives ?",
    ...
    impact_summary:
      "Ajoute une projection de suivi impayes avec facettes montant et niveau de relance.",
  ...
  },
  {
    ...
    business_question:
      "Quels baux arrivent a echeance dans les 90 prochains jours ?",
  ...
  },
  {
    ...
    business_question:
      "Quels immeubles ont des quotites qui ne totalisent pas le quota_basis ?",
    ...
    impact_summary:
      "Projection de controle quotites pour conformite copropriete.",
  ...
  },
  {
    ...
    business_question:
      "Quels lots n'ont ni proprietaire occupant ni locataire declare ?",
    ...
    ai_agent_jobs: [
      "detecter lots sans lien occupation",
      "croiser baux et menages"
    ],
  ...
  },
  {
    ...
    business_question:
      "Quelles 3 a 5 actions doivent remonter au gestionnaire aujourd'hui ?",
    description:
      "Resume les arbitrages qui changent le resultat de la journee.",
    suggested_proj_type: "STEP",
    ...
    impact_summary:
      "Projection d'attention quotidienne consommant les autres signaux.",
...
export const JTBD_HUMAN_PATTERNS = [
  {
    ...
    business_question:
      "Quand plusieurs signaux se contredisent, quelle decision puis-je prendre avec suffisamment de preuves ?",
    description:
      "Vue d'arbitrage humain: preuves, confiance, responsabilite et impact.",
    suggested_proj_type: "STEP",
    ...
    impact_summary:
      "Projection d'aide a la decision centree sur preuve et confiance.",
  ...
  },
  {
    ...
    business_question:
      "Que faut-il coordonner pour la prochaine intervention sur un lot ou une zone commune ?",
    ...
    impact_summary:
      "Complete les projections manager avec une vue execution terrain.",
...
export const JTBD_AI_PATTERNS = [
  {
    ...
    business_question:
      "Quels signaux dois-je surveiller et remonter sans saturer le gestionnaire ?",
    description:
      "Role agent IA de veille: filtrage, explication, priorisation.",
    suggested_proj_type: "STEP",
    retrieval_jobs: ["monitor", "summary"],
    ...
    impact_summary:
      "Formalise une projection consommee par agent IA avant synthese humaine.",
  ...
  },
  {
    ...
    business_question:
      "Quelles incoherences entre paiements CODA et appels de charges dois-je investiguer ?",
