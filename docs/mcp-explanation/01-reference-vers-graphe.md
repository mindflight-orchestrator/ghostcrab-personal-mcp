...
- [`projections.seed.jsonl`](../../examples/immeuble/reference/projections.seed.jsonl) — seed optionnel working memory
...
Suite : [02 — MCP, ontologie et gap-rules](02-mcp-ontologie-gap-rules.md) · [03 — Projections](03-projections-expliquees.md)
