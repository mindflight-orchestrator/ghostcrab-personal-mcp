...
`ghostcrab_remember` = notes textuelles (FACTs agent dans table `facets`) — **pas** le graphe structuré.
...
- [Projections expliquées](./03-projections-expliquees.md) — ce qu'est (et n'est pas) une projection
