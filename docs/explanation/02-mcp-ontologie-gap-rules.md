...
| `ghostcrab_remember` | Notes textuelles (FACTs agent) | **Pas** le graphe — table `agent_facts` |
...
Suite : [03 — Mémoire MCP](03-memoire-mcp-facettes-graphe-projections.md) → [04 — Réindexation](04-reindexation-ghostcrab.md) → [05 — Projections](05-projections-expliquees.md)
