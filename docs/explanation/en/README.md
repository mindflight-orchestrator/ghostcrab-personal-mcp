...
> **Illustration concrète du processus MCP** — ne pas utiliser comme modèle mental pour mémoire, facettes ou projections. Architecture : [`../README.md`](../README.md).
...
| What is a projection? A graph query? | [05 — Projections explained](05-projections-explained.md) (stub → FR architecture) |

Architecture (not lab):

| Topic | Document |
|-------|----------|
| Memory, facets, graph | [03 — Memory MCP](../03-memoire-mcp-facettes-graphe-projections.md) (FR) |
| Reindexation | [04 — Reindex](../04-reindexation-ghostcrab.md) (FR) |
| Projections Type A/B | [05 — Projections](../05-projections-expliquees.md) (FR) |
