...
`ghostcrab_remember` = text notes (agent FACTs in `agent_facts` table) — **not** the structured graph.
...
- [Projections explained](05-projections-explained.md) (stub) · canonical FR: [05 — Projections](../05-projections-expliquees.md)
