...
- a partial platform install (backend only, no `ghostcrab-document`) allows MCP but not ontology/document/structured-import CLI until the full platform package is installed
