...
- **Registry** access for pulls in your manifest: `gcp env set registry.token …` and optional `registry.url` (see [GCP_CLIENT_SETUP.md](./GCP_CLIENT_SETUP.md)).
...
- [GCP_COMMANDS.md](./GCP_COMMANDS.md) — full `gcp` command table
- [GCP_CLIENT_SETUP.md](./GCP_CLIENT_SETUP.md) — config, env, demo profiles overview
