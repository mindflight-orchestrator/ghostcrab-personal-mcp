...
export const statusTool: ToolHandler = {
  ...
  async handler(args, context) {
    ...
    if (context.database.kind === "sqlite") {
      ...
      const sqliteCapabilities = {
        ...
        mb_ontology: {
          ...
          marketplace_by_domain: sqliteNativeReadiness.ontology.marketplaceByDomain,
          ...
          register_relation_type: sqliteNativeReadiness.ontology.registerRelationType,
          ...
          ontology_coverage_ref: sqliteNativeReadiness.ontology.computeOntologyCoverage,
          ingest_knowledge_chunk: sqliteNativeReadiness.ontology.ingestKnowledgeChunk,
          ingest_knowledge_batch: sqliteNativeReadiness.ontology.ingestKnowledgeBatch,
          create_project_template: sqliteNativeReadiness.ontology.createProjectTemplate,
    ...
    throw new Error(
      `Unsupported database kind for ghostcrab_status: ${context.database.kind}`
    );
  }
};
