...
function printGlobalHelp(): void {
  const lines = [
    ...
    "  maintenance register-pg-facets     Register mfo_facets with pg_facets (requires pg_facets + migration 008)",
    "  maintenance merge-facet-deltas     Apply pg_facets merge_deltas on mfo_facets (requires pg_facets)"
  ];
