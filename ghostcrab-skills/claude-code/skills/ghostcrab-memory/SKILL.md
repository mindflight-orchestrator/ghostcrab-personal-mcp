...
Follow [shared/ONBOARDING_CONTRACT.md](../../../shared/ONBOARDING_CONTRACT.md) before any GhostCrab tool call.
...
For multi-session work, checkpoint at meaningful phase boundaries and preserve transition rationale before overwriting current-state records. Use [shared/TRANSITION_LOGGING.md](../../../shared/TRANSITION_LOGGING.md) as the pattern.
