...
Resolve `{starterkit}` via [STARTERKIT_PATHS.md](../../shared/STARTERKIT_PATHS.md) — runtime Q&A tail of `{starterkit}/personal-mcp/SOP_SEQUENCE.md` after operator and evidence-discovery.
