...
References: [GAP_TAXONOMY.md](../../shared/GAP_TAXONOMY.md), [ARTIFACT_KINDS.md](../../shared/ARTIFACT_KINDS.md), [MCP_VS_GCP_ROUTING.md](../../shared/MCP_VS_GCP_ROUTING.md), [IMPORT_CLOSURE_GATES.md](../../shared/IMPORT_CLOSURE_GATES.md), [ENUM_BUSINESS_FACETS.md](../../shared/ENUM_BUSINESS_FACETS.md).

## Delivery context (optional)

Resolve `{starterkit}` via [STARTERKIT_PATHS.md](../../shared/STARTERKIT_PATHS.md) — audit and gate 7–9 phases in `{starterkit}/personal-mcp/SOP_SEQUENCE.md`.
...
5. `ghostcrab_facet_inspect` for expected business enum keys — must match [ENUM_BUSINESS_FACETS.md](../../shared/ENUM_BUSINESS_FACETS.md) naming.
