...
References: [RUNTIME_QUERY_PIPELINE.md](../../shared/RUNTIME_QUERY_PIPELINE.md), [MCP_VS_GCP_ROUTING.md](../../shared/MCP_VS_GCP_ROUTING.md), [ARTIFACT_KINDS.md](../../shared/ARTIFACT_KINDS.md).

## Delivery context (optional)

When the user runs a starter-kit delivery project: `starter-kit-ghostcrab-perso/starterkit/personal-mcp/SOP_SEQUENCE.md` and [SKILL_ROUTE_MAP_ESSENTIALS.md](../../shared/SKILL_ROUTE_MAP_ESSENTIALS.md).
