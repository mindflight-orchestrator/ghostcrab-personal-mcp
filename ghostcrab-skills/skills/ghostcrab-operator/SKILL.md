...
References: [RUNTIME_QUERY_PIPELINE.md](../../shared/RUNTIME_QUERY_PIPELINE.md), [MCP_VS_GCP_ROUTING.md](../../shared/MCP_VS_GCP_ROUTING.md), [ARTIFACT_KINDS.md](../../shared/ARTIFACT_KINDS.md), [ENUM_BUSINESS_FACETS.md](../../shared/ENUM_BUSINESS_FACETS.md).

## Delivery context (optional)

When the user runs a starter-kit delivery project: resolve `{starterkit}` via [STARTERKIT_PATHS.md](../../shared/STARTERKIT_PATHS.md), then load `{starterkit}/personal-mcp/SOP_SEQUENCE.md` and [SKILL_ROUTE_MAP_ESSENTIALS.md](../../shared/SKILL_ROUTE_MAP_ESSENTIALS.md).
...
- For domain enum filters, use `<module>.<slot_snake_case>` facet keys — never bare slot names (see [ENUM_BUSINESS_FACETS.md](../../shared/ENUM_BUSINESS_FACETS.md)).
