...
**Resolve paths first:** [STARTERKIT_PATHS.md](../../shared/STARTERKIT_PATHS.md).
...
For multi-module domains with LinkML enums, include [ENUM_BUSINESS_FACETS.md](../../shared/ENUM_BUSINESS_FACETS.md) in the prompt — facet keys must use `<module>.<slot_snake_case>` without the user having to ask.
