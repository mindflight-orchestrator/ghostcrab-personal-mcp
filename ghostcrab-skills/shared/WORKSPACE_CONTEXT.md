...
|---------|---------|-----------------|
| **CLI workspace** | `--workspace my-app` in `mcp.json` args | Which **SQLite file** the MCP process opens |
| **MindBrain workspace_id** | `default`, `immeuble-demo` | Logical **partition inside** that SQLite file |
