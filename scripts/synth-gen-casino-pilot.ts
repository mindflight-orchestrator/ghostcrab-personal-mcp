 ...
 *
 * Reads the workspace model export (docs/contracts/examples/casino-benchmark.export.json
...
const EXPORT_PATH = process.argv[2]
  ?? resolve(__dirname, "../docs/contracts/examples/casino-benchmark.export.json");
