...
for (const requiredPath of [
  ...
  "bin/ide-skills/shared/ARTIFACT_KINDS.md",
  "bin/ide-skills/shared/SKILL_ROUTE_MAP_ESSENTIALS.md",
  "bin/ide-skills/cursor/skills/ghostcrab-memory/SKILL.md",
  "bin/ide-skills/cursor/skills/ghostcrab-operator/SKILL.md",
  "bin/ide-skills/codex/skills/ghostcrab-memory/SKILL.md",
  "bin/ide-skills/codex/skills/ghostcrab-memory/agents/openai.yaml",
  "bin/ide-skills/codex/skills/ghostcrab-operator/SKILL.md",
  "bin/ide-skills/codex/skills/ghostcrab-operator/agents/openai.yaml",
  ...
  "ghostcrab-skills/shared/ARTIFACT_KINDS.md",
  "ghostcrab-skills/skills/ghostcrab-memory/SKILL.md",
  "ghostcrab-skills/skills/ghostcrab-operator/SKILL.md",
