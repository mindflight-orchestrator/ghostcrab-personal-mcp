...
const CASINO_EXPORT_PATH = resolve(ROOT, "docs/contracts/examples/casino-benchmark.export.json");
const SCHEMA_CONTRACT_PATH = resolve(ROOT, "docs/contracts/workspace-model-export.schema.json");
...
const README_PATH = resolve(ROOT, "docs/contracts/README.md");
...
describe("PR-5 contract integrity", () => {
  it("docs/contracts/workspace-model-export.schema.json exists", () => {
  ...
  it("docs/contracts/README.md exists and covers key topics", () => {
...
describe("casino-pilot fixture integrity", () => {
  ...
  it("expected-counts.json exists and has correct structure", () => {
    ...
    expect(layer2.mfo_facets).toBeDefined();
...
describe("synth scripts integrity", () => {
  ...
  it("synth-derive-casino.ts verifies all 3 Layer 2 surfaces", () => {
    ...
    expect(content).toContain("mfo_facets");
...
describe("all domain examples consistency", () => {
  const examplesDir = resolve(ROOT, "docs/contracts/examples");
  const examples = [
