...
describe("startMcpServer", () => {
  ...
  it("connects transport and skips PostgreSQL bootstrap in sqlite mode", async () => {
  ...
  it("includes a database-unreachable warning in MCP server instructions when database is down", async () => {
    pingMock.mockResolvedValue(false);
    ...
    expect(serverOptions.instructions).toContain("WARNING: database is unreachable");
  });
});
